...
use crate::{
    self as turbo_tasks, manager::read_task_collectibles, primitives::RawVcSet, vc::Vc,
    CollectiblesFuture, RawVc, TraitTypeId,
};

#[turbo_tasks::function]
#[allow(dead_code)] // It's used indirectly
pub async fn read_collectibles(raw: RawVc, trait_type: usize) -> Result<Vc<RawVcSet>> {
