...
pub fn value_impl(_args: TokenStream, input: TokenStream) -> TokenStream {
    ...
    fn generate_for_trait_impl(
        ...
        quote! {
            ...
            impl turbo_tasks::vc::AsDyn<dyn #trait_path> for #struct_ident {}

            impl turbo_tasks::vc::ValueInto<#trait_ref_path> for #struct_ident {
                fn value_into(vc: turbo_tasks::vc::Vc<Self>) -> #trait_ref_path {
                    vc.node.into()
                }
            }
